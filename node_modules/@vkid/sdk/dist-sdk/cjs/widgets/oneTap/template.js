...
var vkjs = require('@vkontakte/vkjs');
...
var getOneTapTemplate = function(param) {
    var width = param.width, height = param.height, iframeHeight = param.iframeHeight, borderRadius = param.borderRadius, openFullAuth = param.openFullAuth, skin = param.skin, scheme = param.scheme, _param_lang = param.lang, lang$1 = _param_lang === void 0 ? types.Languages.RUS : _param_lang, renderOAuthList = param.renderOAuthList, providers = param.providers;
    return function(id) {
        var textIconLimit = 0;
        var textLongLimit = 0;
        var textShortWidth = 0;
        var textLongWidth = 0;
        var initialText = lang.shortLang[lang$1];
        var shortText = lang.providerLang;
        var longText = lang.longLang[lang$1];
        var textPadding = 8;
        ...
        var handleLoaded = function() {
            ...
            var observer = new ResizeObserver_es(vkjs.debounce(observeCallback, 500));
