   ...
   */ function onBridgeMessageHandler(event) {
        ...
        },
        {
            ...
            value: function getWidgetFrameSrc(config, params) {
                var queryParams = _object_spread_props(_object_spread({}, params), {
                    code_challenge: oauth.generateCodeChallenge(),
        ...
        },
        {
            ...
            function redirectWithPayload(payload) {
                location.assign(url.getRedirectWithPayloadUrl(payload, Widget.__config));
            }
        }
    ]);
    return Widget;
}(dispatcher.Dispatcher);
_define_property(Widget, "__config", void 0);
_define_property(Widget, "__auth", void 0);
_ts_decorate([
    validator.validator({
        container: [
            rules.isRequired
