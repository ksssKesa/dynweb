(function (global, factory) {
  ...
  var getVKIDUrl = function(module, params, config) {
      var queryParams = _object_spread_props$3(_object_spread$5({}, params), {
          uuid: uuid(),
          v: VERSION,
          sdk_type: "vkid",
          app_id: config.app,
  ...
  var _obj$8;
  (_obj$8 = {}, _define_property$g(_obj$8, AuthErrorCode.EventNotSupported, "Event is not supported"), _define_property$g(_obj$8, AuthErrorCode.CannotCreateNewTab, "Cannot create new tab. Try checking your browser settings"), _define_property$g(_obj$8, AuthErrorCode.NewTabHasBeenClosed, "New tab has been closed"), _define_property$g(_obj$8, AuthErrorCode.AuthorizationFailed, "Authorization failed with an error"), _obj$8);
  ...
  var Auth = function Auth() {
      _class_call_check$8(this, Auth);
      _define_property$f(this, "login", function(params) {
          ...
          var url = getVKIDUrl("auth", queryParams, Auth.__config.get());
          location.assign(url);
      });
  };
  _define_property$f(Auth, "__config", void 0);
  ...
  var Config = /*#__PURE__*/ function() {
      function Config() {
          _class_call_check$7(this, Config);
          _define_property$e(this, "store", {
              app: 0,
              redirectUrl: "",
      ...
      _create_class$7(Config, [
          {
              key: "set",
              value: function set(config) {
                  this.store = _object_spread$4({}, this.store, config);
                  return this;
              }
          },
          {
  ...
  var _obj1$3, _obj2$2;
  var singleButtonText = (_obj2$2 = {}, _define_property$7(_obj2$2, exports.Languages.RUS, (_obj1$3 = {}, _define_property$7(_obj1$3, exports.OAuthName.OK, "Войти через OK"), _define_property$7(_obj1$3, exports.OAuthName.MAIL, "Войти с Почтой Mail.ru"), _define_property$7(_obj1$3, exports.OAuthName.VK, "Войти с VK ID"), _obj1$3)), _define_property$7(_obj2$2, exports.Languages.UKR, "Увійти з {provider}"), _define_property$7(_obj2$2, exports.Languages.ENG, "Sign in with {provider}"), _define_property$7(_obj2$2, exports.Languages.SPA, "Iniciar sesi\xf3n con {provider}"), _define_property$7(_obj2$2, exports.Languages.GERMAN, "Mit {provider} anmelden"), _define_property$7(_obj2$2, exports.Languages.POL, "Zaloguj się z {provider}"), _define_property$7(_obj2$2, exports.Languages.FRA, "Se connecter avec {provider}"), _define_property$7(_obj2$2, exports.Languages.TURKEY, "{provider}'den gir"), _obj2$2);
  ...
  var getOneTapTemplate = function(param) {
      ...
      return function(id) {
          ...
          return '\n<div id="'.concat(id, '" data-test-id="oneTap" data-scheme="').concat(scheme, '" data-skin="').concat(skin, '">\n  <style>\n    #').concat(id, " {\n      position: relative;\n      width: ").concat(width ? "".concat(width, "px") : "100%", ";\n      min-width: ").concat(height, "px;\n    }\n\n    #").concat(id, "[data-state=loaded] {\n      height: ").concat(iframeHeight, "px;\n    }\n\n    #").concat(id, " iframe {\n      position: absolute;\n      top: 0;\n      left: 0;\n      opacity: 0;\n      pointer-events: none;\n      border: none;\n      color-scheme: auto;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_reset_").concat(id, " {\n      border: none;\n      margin: 0;\n      padding: 0;\n      width: auto;\n      overflow: visible;\n      background: transparent;\n      color: inherit;\n      font: inherit;\n      line-height: normal;\n      -webkit-font-smoothing: inherit;\n      -moz-osx-font-smoothing: inherit;\n      -webkit-appearance: none;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_").concat(id, " {\n      padding: ").concat(padding, "px;\n      height: ").concat(height, "px;\n      width: 100%;\n      border-radius: ").concat(borderRadius, "px;\n      box-sizing: border-box;\n      overflow: hidden;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_animation_").concat(id, " {\n      transition: .2s ease;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_").concat(id, ":hover {\n      cursor: pointer;\n    }\n\n    #").concat(id, "[data-scheme=light][data-skin=primary] .VkIdWebSdk__button_").concat(id, ",\n    #").concat(id, "[data-scheme=dark][data-skin=primary] .VkIdWebSdk__button_").concat(id, " {\n      background: #0077FF;\n    }\n\n    #").concat(id, "[data-scheme=light][data-skin=secondary] .VkIdWebSdk__button_").concat(id, " {\n      background: rgba(255, 255, 255, 0.12);\n      border: 1px solid rgba(0, 0, 0, 0.12);\n    }\n\n    #").concat(id, "[data-scheme=dark][data-skin=secondary] .VkIdWebSdk__button_").concat(id, " {\n      background: transparent;\n      border: 1px solid rgba(255, 255, 255, 0.12);\n    }\n\n    #").concat(id, "[data-scheme=light][data-skin=primary] .VkIdWebSdk__button_").concat(id, ":focus,\n    #").concat(id, "[data-scheme=light][data-skin=primary] .VkIdWebSdk__button_").concat(id, ":hover {\n      background: #0071F2;\n    }\n\n    #").concat(id, "[data-scheme=dark][data-skin=primary] .VkIdWebSdk__button_").concat(id, ":focus,\n    #").concat(id, "[data-scheme=dark][data-skin=primary] .VkIdWebSdk__button_").concat(id, ":hover {\n      background: #097EFF;\n    }\n\n    #").concat(id, "[data-scheme=light][data-skin=secondary] .VkIdWebSdk__button_").concat(id, ":focus,\n    #").concat(id, "[data-scheme=light][data-skin=secondary] .VkIdWebSdk__button_").concat(id, ":hover {\n      background: #F5F5F7;\n    }\n\n    #").concat(id, "[data-scheme=dark][data-skin=secondary] .VkIdWebSdk__button_").concat(id, ":focus,\n    #").concat(id, "[data-scheme=dark][data-skin=secondary] .VkIdWebSdk__button_").concat(id, ":hover {\n      background: rgba(255, 255, 255, 0.06);\n    }\n\n    #").concat(id, "[data-scheme=light][data-skin=primary] .VkIdWebSdk__button_").concat(id, ":active {\n      background: #0069E1;\n    }\n\n    #").concat(id, "[data-scheme=dark][data-skin=primary] .VkIdWebSdk__button_").concat(id, ":active {\n      background: #1385FF;\n    }\n\n    #").concat(id, "[data-scheme=light][data-skin=secondary] .VkIdWebSdk__button_").concat(id, ":active {\n      background: #EBECEF;\n    }\n\n    #").concat(id, "[data-scheme=dark][data-skin=secondary] .VkIdWebSdk__button_").concat(id, ":active {\n      background: rgba(255, 255, 255, 0.1);\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_in_").concat(id, " {\n      display: inline-block;\n      width: 100%;\n      height: 100%;\n      min-width: max-content;\n      transition: width 0.5s;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_content_").concat(id, " {\n      display: flex;\n      align-items: center;\n      justify-content: space-between;\n      height: 100%;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_logo_").concat(id, ",\n    #").concat(id, " .VkIdWebSdk__button_spinner_").concat(id, ",\n    #").concat(id, " .VkIdWebSdk__button_logo_").concat(id, " > svg,\n    #").concat(id, " .VkIdWebSdk__button_spinner_").concat(id, " > svg {\n      width: ").concat(logoSize, "px;\n      height: ").concat(logoSize, "px;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_spinner_").concat(id, " > svg {\n      position: absolute;\n      right: ").concat(padding, "px;\n      animation: vkIdSdkButtonSpinner 0.7s linear infinite;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_text_").concat(id, ' {\n      font-family: -apple-system, system-ui, "Helvetica Neue", Roboto, sans-serif;\n      font-weight: 500;\n      font-size: ').concat(fontSize, "px;\n      transition: .2s;\n      white-space: nowrap;\n      text-overflow: ellipsis;\n      overflow: hidden;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_text_").concat(id, " > span {\n      opacity: 0;\n      display: inline-block;\n      padding: 0 ").concat(textPadding, "px;\n      transition: .5s;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_text_").concat(id, " > span[data-active=true] {\n      opacity: 1;\n    }\n\n    #").concat(id, " .VkIdWebSdk__button_text_").concat(id, ",\n    #").concat(id, " .VkIdWebSdk__button_spinner_").concat(id, " {\n      color: #ffffff;\n    }\n\n    .VkIdWebSdk__oauthList_container_").concat(id, " {\n      margin-top: 16px;\n    }\n\n    #").concat(id, "[data-scheme=light][data-skin=secondary] .VkIdWebSdk__button_text_").concat(id, ",\n    #").concat(id, "[data-scheme=light][data-skin=secondary] .VkIdWebSdk__button_spinner_").concat(id, " {\n      color: #000000;\n    }\n\n    #").concat(id, "[data-skin=secondary] #logoName {\n      fill: #0077FF;\n    }\n\n    #").concat(id, "[data-skin=secondary] #logoBg {\n      fill: #FFFFFF;\n    }\n\n    #").concat(id, "[data-state=not_loaded] .VkIdWebSdk__button_in_").concat(id, " {\n      width: 0;\n    }\n\n    #").concat(id, "[data-state=not_loaded] .VkIdWebSdk__button_spinner_").concat(id, " {\n      transition: .2s;\n      opacity: 0;\n      pointer-events: none;\n      width: 0;\n    }\n\n    #").concat(id, "[data-state=loaded] .VkIdWebSdk__oauthList_container_").concat(id, " {\n      display: none;\n    }\n\n    #").concat(id, "[data-state=loaded] iframe {\n      position: initial;\n      opacity: 100;\n      pointer-events: all;\n    }\n\n    #").concat(id, "[data-state=loaded] .VkIdWebSdk__button_").concat(id, ' {\n      display: none;\n    }\n\n    @keyframes vkIdSdkButtonSpinner {\n      0% {\n        transform: rotate(0deg);\n      }\n      100% {\n        transform: rotate(360deg);\n      }\n    }\n  </style>\n  <iframe width="100%" height="100%" />\n</div>\n  ');
      };
  };
  ...
  var _obj1$1;
  var CONTINUE = (_obj1$1 = {}, _define_property$3(_obj1$1, exports.Languages.RUS, "Продолжить с VK ID"), _define_property$3(_obj1$1, exports.Languages.UKR, "Продовжити з VK ID"), _define_property$3(_obj1$1, exports.Languages.ENG, "Continue with VK ID"), _define_property$3(_obj1$1, exports.Languages.SPA, "Continuar con VK ID"), _define_property$3(_obj1$1, exports.Languages.GERMAN, "Mit VK-ID fortfahren"), _define_property$3(_obj1$1, exports.Languages.POL, "Kontynuuj z VK ID"), _define_property$3(_obj1$1, exports.Languages.FRA, "Continuer avec VK ID"), _define_property$3(_obj1$1, exports.Languages.TURKEY, "VK ID aracılığıyla devam et"), _obj1$1);
  var _obj2$1;
  var MAKE_ORDER = (_obj2$1 = {}, _define_property$3(_obj2$1, exports.Languages.RUS, "Оформить с VK ID"), _define_property$3(_obj2$1, exports.Languages.UKR, "Оформити з VK ID"), _define_property$3(_obj2$1, exports.Languages.ENG, "Order with VK ID"), _define_property$3(_obj2$1, exports.Languages.SPA, "Pedir con VK ID"), _define_property$3(_obj2$1, exports.Languages.GERMAN, "Mit VK-ID bestellen"), _define_property$3(_obj2$1, exports.Languages.POL, "Wypełnij z VK ID"), _define_property$3(_obj2$1, exports.Languages.FRA, "Commander avec VK ID"), _define_property$3(_obj2$1, exports.Languages.TURKEY, "VK ID aracılığıyla oluştur"), _obj2$1);
  var getButtonLang = function(contentId, lang) {
      switch(contentId){
          ...
          case exports.FloatingOneTapContentId.SUBMIT_APPLICATIONS:
              return CONTINUE[lang] || CONTINUE[exports.Languages.RUS];
